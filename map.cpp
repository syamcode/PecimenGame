...
int level2[20][20]= {
                    ...
                    {13, 3,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7, 13},
...
//struktur data aray untuk level 2 berukuran 20x20 (by Pega)
 int level3[20][20]= {
                    ...
                    {13, 32,  3,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  32, 13},
                    {17, 12, 12,12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 16}
                    };
...
int level4[20][20]= {
                    ...
                    {13,  7,  7, 18,  7,  7, 13, 13,  1,  1,  1,  1, 13, 13,  7,  7, 18,  7,  7, 13},
                    ...
                    {13, 19,  3,  7,  7, 19,  7,  7,  7, 19, 19,  7,  7,  7, 19,  7,  7,  7, 19, 13},
...
int level6[20][20]={
                  ...
                  { 7,	 3,	18,	 7,	 7,	 7,	18,	 7,	 7,	 7,	 7,	 7,	 7,	18,	 7,	 7,	 7,	 7,	 32,	13},
                  ...
                  {13,	19,	 7,	19,	 7,	 7,	 7,	13,	 7,	 7,	 7,	 7,	13,	 7,	 7,	 7,	19,	 7,	19,	13},
...
void autoPath() {
    ...
    for(i=0;i<20;i++) {
        for(j=0;j<20;j++) {
            if(levelMap[j][i].node!=-1 && levelMap[j][i].Wall==0) {
                for(k=1;k<=4;k++) {
                    switch(k) {
...
void generateNodes() {
    ...
    for(j=1;j<20;j++) {
        for(i=1;i<20;i++) {
            c = 0;
            if (levelMap[i+1][j].Wall==0 && levelMap[i][j+1].Wall==0) {
                c++;
            }
            if (levelMap[i+1][j].Wall==0 && levelMap[i][j-1].Wall==0) {
                c++;
